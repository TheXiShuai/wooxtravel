...
class AdminsController extends Controller
{
    ...
    public function storeAdmins(Request $request)
    {
        ...
        if ($storeAdmins) {
            ...
            return redirect()->route('admins.all.admins')->with(['success' => 'Admin created succesfully']);
        }
    }
    ...
    public function storeCountries(Request $request)
    {
        ...
        if ($storeCountries) {
            ...
            return Redirect::route('all.countries')->with(['success' => 'Country created succesfully']);
        }
    }
    ...
    public function deleteCountries($id)
    {
        ...
        if ($deleteCountry) {
            ...
            return Redirect::route('all.countries')->with(['delete' => 'Country deleted succesfully']);
        }
    }
    ...
    public function storeCities(Request $request)
    {
        ...
        if ($storeCities) {
            ...
            return redirect()->route('all.cities')->with(['success' => 'City created succesfully']);
        }
    }
    ...
    public function deleteCities($id)
    {
        ...
        if (File::exists(public_path('assets/images/' . $deleteCity->image))) {
            ...
            // Handle the case when the file does not exist, e.g., log or display a message
